...
parser.add_argument('--segment_folder', type=str, default="data/test")
parser.add_argument('--match_segment_csv', type=str, default="data/test/matched_segments.csv")
parser.add_argument('--out_folder', type=str, default="data/test/output")
...
parser.add_argument('--num_point', type=int, default=512)
parser.add_argument('--patch_num_point', type=int, default=512)
...
parser.add_argument('--steps_per_visu', type=int, default=20)
...
parser.add_argument('--line_fit_w', default=50.0, type=float, help="line_fit_weight")
